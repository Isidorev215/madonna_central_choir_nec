<template>
  <div class="flex flex-wrap lg:shadow-md lg:rounded-lg flex-row mb-8">
    <div class="flex-shrink max-w-full w-full lg:w-1/3 mb-4 lg:mb-0">
    ...
    <div class="flex-shrink max-w-full w-full lg:w-1/3 mb-4 lg:mb-0 lg:border-x border-gray-300">
    ...
    <div class="flex-shrink max-w-full w-full lg:w-1/3">
