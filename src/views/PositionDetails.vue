<template>
  <div class="position-details">
    ...
    >
      <div class="left col-span-3 lg:col-span-2 flex flex-col justify-start items-start space-y-3 px-4">
        <div class="w-full">
          <div class="bg-white rounded shadow-s1 p-3 lg:p-5">
            ...
            <div class="mb-2 w-full flex justify-between items-center">
              ...
              <div class="text-sm flex justify-start items-stretch">
            ...
            <div class="edit-button w-full flex justify-end items-center">
              <button type="button" @click="openToEditPosition = true" class="p-2 bg-mcc-blue text-white font-medium flex justify-center items-center rounded">Edit Position</button>
            </div>
          </div>
        </div>
        ...
        <div class="form-fields w-full grid grid-cols-1 gap-3 lg:gap-8 p-3 lg:p-5 bg-white rounded shadow-s1">
          ...
          <div class="w-full grid grid-cols-1 gap-1">
            ...
            >
              ...
              <FormKit
                v-for="(duty, index) in position.duties"
                :key="duty"
                :value="duty"
                type="text"
        ...
        <div class="select-users w-full grid grid-cols-1 gap-3 lg:gap-8 p-3 lg:p-5 bg-white rounded shadow-s1">
          ...
          <div class="users-list">
            <div class="flex flex-col justify-start items-start space-y-4">
              ...
              <ul class="w-full flex flex-col justify-start items-start space-y-3 lg:space-y-4 max-h-[420px] overflow-y-auto">
...
const selectUser = (event, id) => {
  let checkedUser = users.value.find((user) => user._id === id);
  if (event.target.checked) {
...
const editPosition = async (position_id) => {
  ...
  console.log(position_id, formOutput)
}
